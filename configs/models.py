...
from mtn import MTN, FCEncoder, ImageDecoder, ConvEncoder, ConvEncoderLargeBottleneck, ImageDecoderLargeBottleneck
from wifi_faster_rcnn import WifiFasterRCNN
from preprocessor import CSIDetDataPreprocessor
...
model = dict(
    ...
    data_preprocessor=dict(
        type=CSIDetDataPreprocessor,
        ),
    mtn=dict(
        type=MTN,
        encoder=dict(
            type=ConvEncoderLargeBottleneck
        ),
        decoder=dict(
            type=ImageDecoder
        ),
